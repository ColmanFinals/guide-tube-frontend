    ...
    return (
        <div className="flex flex-col items-center w-full" style={{margin: "2vh", maxHeight: "50%"}}>
            ...
            <div className="bg-black p-6 rounded-lg ">
                <p className="text-white-400" style={{fontSize: "1em"}}>GuideTube is the premier voice-controlled
                    platform for seamless, hands-free guide navigation, perfect for any task that requires your full
                    attention.</p>
